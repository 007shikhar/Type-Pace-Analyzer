...
def login():
    ...
    def check_vals():
        if (user_var.get() +"\n" not in user_list):
            ...
            path = os.getcwd()
            f = open(path+'\\' +user_var.get()+'\\' + user_var.get()+ '.txt', 'r')
            details=f.readlines()
            if(details[3] != pswd_var.get()):
                ...
                def random_sen_test():
                    ...
                    def calculate(*args, **kwargs):
                        ...
                        path = os.getcwd()
                        f = open(path + '\\' + user_id + '\\' + "HISTORY.txt", 'r')
                        records = f.readlines()
                        f.close()
                        ...
                        if (len(records) >= 5):
                            now = datetime.now()
                            lineList = [line.rstrip('\n') for line in open(path + '\\' + user_id + '\\' + "HISTORY.txt")]
                            rec=str(str(now.strftime("%d/%m/%Y, %H:%M:%S")) + '#' + str(w_count) + '#' + str(round(t1 - t0)) + '#' + temp)
                            lineList[0]=rec
                            lst_4=lineList[1:]
                            lineList[1]=lst_4[0]
                            lineList[2] = lst_4[1]
                    ...
                    def history():
                        ...
                        if(len(records)<5):
                            ...
                            records_list1=records[0].split('#')
                            d_t1 = Label(show, width='20', height='2', text=str(records_list1[0]), font="Arial 10 bold").grid(
                                row=1, column=0)
                            w = Label(show, width='20', height='2', text=str(records_list1[1]), font="Arial 10 bold").grid(
                                row=1, column=1)
                            t = Label(show, width='20', height='2',text=str(records_list1[2]), font="Arial 10 bold").grid(
                                row=1, column=2)
                            s = Label(show, width='20', height='2',text=str(records_list1[3]), font="Arial 10 bold").grid(
                                row=1, column=3)

                            records_list2 = records[1].split('#')
                            d_t1 = Label(show, width='20', height='2', text=str(records_list2[0]),
                                         font="Arial 10 bold").grid(
                                row=2, column=0)
                            w = Label(show, width='20', height='2', text=str(records_list2[1]),
                                      font="Arial 10 bold").grid(
                                row=2, column=1)
                            t = Label(show, width='20', height='2', text=str(records_list1[2]),
                                      font="Arial 10 bold").grid(
                                row=2, column=2)
                            s = Label(show, width='20', height='2', text=str(records_list1[3]),
                                      font="Arial 10 bold").grid(
                                row=2, column=3)

                            records_list3 = records[2].split('#')
                            d_t1 = Label(show, width='20', height='2', text=str(records_list3[0]),
                                         font="Arial 10 bold").grid(
                                row=3, column=0)
                            w = Label(show, width='20', height='2', text=str(records_list3[1]),
                                      font="Arial 10 bold").grid(
                                row=3, column=1)
                            t = Label(show, width='20', height='2', text=str(records_list3[2]),
                                      font="Arial 10 bold").grid(
                                row=3, column=2)
                            s = Label(show, width='20', height='2', text=str(records_list3[3]),
                                      font="Arial 10 bold").grid(
                                row=3, column=3)

                            records_list4 = records[3].split('#')
                            d_t1 = Label(show, width='20', height='2', text=str(records_list4[0]),
                                         font="Arial 10 bold").grid(
                                row=4, column=0)
                            w = Label(show, width='20', height='2', text=str(records_list4[1]),
                                      font="Arial 10 bold").grid(
                                row=4, column=1)
                            t = Label(show, width='20', height='2', text=str(records_list4[2]),
                                      font="Arial 10 bold").grid(
                                row=4, column=2)
                            s = Label(show, width='20', height='2', text=str(records_list4[3]),
                                      font="Arial 10 bold").grid(
                                row=4, column=3)

                            records_list5 = records[4].split('#')
                            d_t1 = Label(show, width='20', height='2', text=str(records_list5[0]),
                                         font="Arial 10 bold").grid(
                                row=5, column=0)
                            w = Label(show, width='20', height='2', text=str(records_list5[1]),
                                      font="Arial 10 bold").grid(
                                row=5, column=1)
                            t = Label(show, width='20', height='2', text=str(records_list5[2]),
                                      font="Arial 10 bold").grid(
                                row=5, column=2)
                            s = Label(show, width='20', height='2', text=str(records_list5[3]),
                                      font="Arial 10 bold").grid(
                                row=5, column=3)
...
def register():
    ...
    def getvals():
        ...
        if (pswd_var.get() != c_pswd_var.get()):
            ...
            users.write(user_var.get() + "\n")
            users.close()

            path = os.getcwd()
            os.mkdir(path + "\\" + user_var.get())
            os.chdir(path + "\\" + user_var.get())

            f=open(user_var.get()+'.txt','w')
            f.write(name_var.get()+'\n'+email_var.get()+'\n'+user_var.get()+'\n'+pswd_var.get())
            f.close()
            f = open('HISTORY.txt', 'w').close()
            os.chdir(path)
